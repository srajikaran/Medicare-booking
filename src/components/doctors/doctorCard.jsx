    ...
    return (
        <div className="p-3 lg:p-5">
            ...
            <div className="mt-2 lg:mt-4 flex items-center justify-between">
                <span className="bg-[#CCF0F3] text-blue-600 py-1 px-2 lg:py-2 lg:px-6
                ...
                <div className="flex items-center gap-[6px]">
                    ...
                    lg:leading-7 font-semibold text-headingColor">
                        <img src={StarIcon} alt="" className="w-[20px] h-[20px]" /> {avgRating}
            ...
            <Link to='/doctors' className="w-[44px] h-[44px] rounded-full border border-solid 
                        border-[#181A1E] flex items-center justify-center group hover:bg-blue-700
                        hover:boder-none">
